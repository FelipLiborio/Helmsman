...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{cccccX}
    ...
    \midrule
    1 & Baixo    & Baixo & Baixo    & Derrubar forte & Completamente ocioso \\
    2 & Baixo    & Baixo & Moderado & Manter         & Ainda há tráfego, não derruba \\
    3 & Moderado & Baixo & Baixo    & Derrubar       & CPU moderada sem demanda \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{ccccccX}
    ...
    11 & Alto     & Moderado & Crítico  & Subir forte & Critical & Demanda crítica no limite \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{ccccccX}
    ...
    15 & Crítico & Baixo   & Baixo & Derrubar       & Critical & CPU crítica sem demanda \\
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{ccccccX}
    ...
    20 & Moderado & Baixo    & Crítico & Subir forte & Warning & CPU crescendo + capacidade no limite \\
    21 & Baixo    & Moderado & Crítico & Subir       & Warning & RAM crescendo + capacidade no limite \\
...
\begin{table}[H]
  ...
  \begin{tabular}{cccc}
    ...
    256 & 8/12 & 4 & 67\% \\
    \midrule
    \textbf{Total} & \textbf{41/60} & \textbf{19} & \textbf{68\%} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lXXl}
    ...
    \midrule
    Precisão nos 12 cenários & 12/12 (100\%) & 41/60 (68\%) & Fuzzy \\
...
As falhas consistentes do AG concentram-se nos cenários T3 (carga real crescente), T5 (host cheio) e T11/T12 (RPS crítico). Essas divergências refletem a natureza estocástica do AG: a função de aptidão captura os critérios corretos, mas a convergência pode ser incompleta em 50 gerações para estados fronteiriços. Aumentar o número de gerações ou o tamanho da população reduziria as falhas ao custo de maior tempo de execução.
...
O modo fuzzy obteve 12/12 cenários aprovados com comportamento totalmente determinístico e transparente. O modo AG obteve 68\% de aprovação em 60 execuções, demonstrando que a função de aptidão multidimensional captura os critérios operacionais corretamente, com variabilidade esperada de um algoritmo estocástico.
